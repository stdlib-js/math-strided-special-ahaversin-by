...
/**
* Interface describing `ahaversinBy`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the inverse half-value versed sine of each element retrieved from an input strided array `x` via a callback function and assigns each result to an element in an output strided array `y` using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param x - input array
	* @param strideX - `x` stride length
...
* // y => [ 0.0, ~1.571, ~3.142, ~1.047, ~2.094 ]
*/
declare var ahaversinBy: Routine;
